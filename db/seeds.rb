...
shower_daily = Task.create(
	name: 'showering',
	timescale: 'daily',
	description: 'This i s a great way to get started on conserving water!
				  By focusing on the length and frequency of your showers, 
				  you can save a huge amount of water!', 
	category_id: water.id)

shower_weekly = Task.create(
	name: 'showering',
	timescale: 'weekly',
	description: 'This i s a great way to get started on conserving water!
				  By focusing on the length and frequency of your showers, 
